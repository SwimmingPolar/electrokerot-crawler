...
router.use('/', async (req: Request, res: Response) => {
   ...
   */
  await page.goto('https://prod.danawa.com/info/?pcode=16101464&cate=112747')
  ...
  const result = await page.evaluate(categories => {
     ...
     * EXTRACT pcode
     */
    const pcode = window.location.search.match(/pcode=([0-9]*)/)?.at(1) || ''
    ...
    const marketTitles =
      Array.from(document.querySelectorAll('#priceCompareArea .diff_tit')) || []
